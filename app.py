...
FREE_TRIAL_LIMIT = 3
WA_URL = “https://wa.me/573228246703?text=Hola%2C+quiero+acceso+completo+Saber+AI+Santander.+Adjunto+comprobante.”
...
resp = client.chat.completions.create(model=“gpt-4o-mini”, max_tokens=1000, messages=api_messages)
