...
st.markdown(”<div class='ok'>Acceso activo<br><small>Codigo: <b>” + active + “</b></small></div>”, unsafe_allow_html=True)
st.markdown(”—”)
count = str(len(st.session_state[“messages”]) // 2)
st.markdown(“Mensajes: **” + count + “**”)
else:
...
div_open = “<div class='" + css_cls + "'>”
st.markdown(div_open + st.session_state[“code_msg”] + “</div>”, unsafe_allow_html=True)
st.markdown(”—”)
...
if trial_exhausted:
st.markdown(”<div class='pw'><h2>Has llegado al limite del demo!</h2><p>Para dominar el ICFES del 26 de Julio adquiere el acceso completo.</p><div class='pi'>Envia $49,000 COP por Nequi al numero<br><strong>3228246703</strong><br><br>Envia el comprobante por WhatsApp y recibe tu codigo.</div></div>”, unsafe_allow_html=True)
wa_html = “<div style='text-align:center;margin-top:1rem;'><a href='" + WA_URL + "' target='_blank' class='wa'>Enviar comprobante por WhatsApp</a></div>”
...
p6 = chr(10) + “- Resumen fortalezas y mejoras.”
p7 = chr(10) + “- Tono motivador santandereano. ICFES 26 julio 2026.”
...
t3 = chr(10) + “Codigo: “ + str(st.session_state[“active_code”])
...
fname = “plan_ICFES_” + str(st.session_state[“active_code”]) + “.txt”
