...
st.markdown(”<div class="ok">Acceso completo activo<br><small>Codigo: <b>” + str(st.session_state.active_code) + “</b></small></div>”, unsafe_allow_html=True)
st.markdown(”—”)
...
try:
client = anthropic.Anthropic()
resp = client.messages.create(model=“claude-sonnet-4-20250514”, max_tokens=1000, system=SYSTEM_PROMPT, messages=[{“role”: m[“role”], “content”: m[“content”]} for m in st.session_state.messages])
